import { Output, custom, customAsync, maxLength, minLength, object, objectAsync, optional, optionalAsync, regex, special, string, stringAsync, transform } from 'valibot';
...
const UpdateBannerHeroDto = objectAsync({
