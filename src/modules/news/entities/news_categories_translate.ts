...
export type NewsCategoriesTranslate =
  typeof newsCategoriesTranslate.$inferSelect;
export type InsertNewsCategoriesTranslate =
  typeof newsCategoriesTranslate.$inferInsert;
